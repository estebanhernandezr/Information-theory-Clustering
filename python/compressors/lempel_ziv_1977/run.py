...
sys.path.insert(0, 'python/compressors/lempel_ziv_1977/decompressor')
...
def run():
    ...
    mensaje_comprimido = compresor.compress('universidad del rosario sede centro bogota colombia', symb='_')
